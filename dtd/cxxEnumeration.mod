...
<!ENTITY % cxxEnumerationDeclarationFileLineStart           "cxxEnumerationDeclarationFileLineStart">
<!ENTITY % cxxEnumerationDeclarationFileLineEnd             "cxxEnumerationDeclarationFileLineEnd">
...
<!ELEMENT cxxEnumerationDeclarationFileLineStart  EMPTY>
<!ATTLIST cxxEnumerationDeclarationFileLineStart   name CDATA #FIXED "lineNumber"
                                                   value CDATA #REQUIRED
                                                   %univ-atts;
                                                   outputclass CDATA #IMPLIED
>

<!ELEMENT cxxEnumerationDeclarationFileLineEnd  EMPTY>
<!ATTLIST cxxEnumerationDeclarationFileLineEnd   name CDATA #FIXED "lineNumber"
                                                 value CDATA #REQUIRED
                                                 %univ-atts;
                                                 outputclass CDATA #IMPLIED
>
...
<!ATTLIST cxxEnumerationDeclarationFileLineStart   %global-atts;
    class  CDATA "- topic/state reference/state apiRef/apiQualifier apiValue/apiQualifier cxxEnumeration/cxxEnumerationDeclarationFileLineStart ">
<!ATTLIST cxxEnumerationDeclarationFileLineEnd   %global-atts;
    class  CDATA "- topic/state reference/state apiRef/apiQualifier apiValue/apiQualifier cxxEnumeration/cxxEnumerationDeclarationFileLineEnd ">
