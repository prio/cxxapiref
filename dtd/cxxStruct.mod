...
<!ENTITY % cxxStructTypedefInherited             "cxxStructTypedefInherited">
...
<!ENTITY % cxxStructDeclarationFileLineStart     "cxxStructDeclarationFileLineStart">
<!ENTITY % cxxStructDeclarationFileLineEnd       "cxxStructDeclarationFileLineEnd">

<!-- ============ Hooks for shell DTD ============ -->
<!ENTITY % cxxStruct-types-default
    "cxxStructNested | cxxFunction | cxxVariable | cxxEnumeration | cxxTypedef | cxxFriend">
...
<!ELEMENT cxxStructTypedefInherited  (#PCDATA)*>
<!ATTLIST cxxStructTypedefInherited   href CDATA #IMPLIED
                                          keyref CDATA #IMPLIED
                                          type   CDATA  #IMPLIED
                                          %univ-atts;
                                          format        CDATA   #IMPLIED
...
<!ELEMENT cxxStructAPIItemLocation   (
                                        ...
                                        %cxxStructDeclarationFileLineStart;,
                                        %cxxStructDeclarationFileLineEnd;
                                     )
>
...
<!ELEMENT cxxStructDeclarationFileLineStart  EMPTY>
<!ATTLIST cxxStructDeclarationFileLineStart   name CDATA #FIXED "lineNumber"
                                             value CDATA #REQUIRED
                                             %univ-atts;
                                             outputclass CDATA #IMPLIED
>

<!ELEMENT cxxStructDeclarationFileLineEnd  EMPTY>
<!ATTLIST cxxStructDeclarationFileLineEnd   name CDATA #FIXED "lineNumber"
                                             value CDATA #REQUIRED
                                             %univ-atts;
                                             outputclass CDATA #IMPLIED
>
...
<!ATTLIST cxxStructDeclarationFileLineStart   %global-atts;
    class  CDATA "- topic/state reference/state apiRef/apiQualifier apiStructifier/apiQualifier cxxStruct/cxxStructDeclarationFileLineStart ">
<!ATTLIST cxxStructDeclarationFileLineEnd   %global-atts;
    class  CDATA "- topic/state reference/state apiRef/apiQualifier apiStructifier/apiQualifier cxxStruct/cxxStructDeclarationFileLineEnd ">
...
<!ATTLIST cxxStructTypedefInherited   %global-atts;
    class  CDATA "- topic/xref reference/xref apiRef/apiRelation apiClassifier/apiRelation cxxStruct/cxxStructTypedefInherited ">  
