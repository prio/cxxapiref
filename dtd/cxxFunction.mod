...
<!ENTITY % cxxFunctionReturnDesc                        "cxxFunctionReturnDesc">
...
<!ENTITY % cxxFunctionExceptionSpecification            "cxxFunctionExceptionSpecification">
...
<!ELEMENT cxxFunctionReturnDesc   (
                                        #PCDATA
                                        | %apiRelation;
                                     )*
>
<!ATTLIST cxxFunctionReturnDesc    %univ-atts;
                                        outputclass CDATA #IMPLIED
>
...
<!ELEMENT cxxFunctionExceptionSpecification   (
                                        #PCDATA
                                        | %apiRelation;
                                     )*
>
<!ATTLIST cxxFunctionExceptionSpecification    %univ-atts;
                                        outputclass CDATA #IMPLIED
>
...
<!ATTLIST cxxFunctionExceptionSpecification   %global-atts;
    class  CDATA "- topic/ph reference/ph apiRef/apiDefItem apiOperation/apiDefItem cxxFunction/cxxFunctionExceptionSpecification ">     
...
<!ATTLIST cxxFunctionReturnDesc   %global-atts;
    class  CDATA "- topic/ph reference/ph apiRef/apiDefNote cxxFunction/cxxFunctionReturnDesc ">    
